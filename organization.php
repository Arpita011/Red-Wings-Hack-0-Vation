...
<body>
    ...
    <h2 style="text-align: center;">Organization/Hospital</h2>
    <br><br>
    <div class="form_up">
    <form method="POST" action="organization_script.php">
        <div class="form-group">
        <input type="text" class="form-control" name="name" id="name" placeholder="Organization/Hospital name" required>
        </div>
  ...
  <div class="form-check">
    <label class="form-check-label">
      ...
      Please make sure the donar has no specific physical problems.
    </label>
  </div>
  <br>
